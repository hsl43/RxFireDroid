...
interface FirebaseDatabase {
  companion object {
    ...
    fun getInstance(): FirebaseDatabase {
      return FirebaseDatabase.getInstance(app = null, url = null)
    }

    fun getInstance(app: FirebaseApp): FirebaseDatabase {
      return FirebaseDatabase.getInstance(app = app, url = null)
    }

    fun getInstance(url: String): FirebaseDatabase {
      return FirebaseDatabase.getInstance(app = null, url = url)
    }
